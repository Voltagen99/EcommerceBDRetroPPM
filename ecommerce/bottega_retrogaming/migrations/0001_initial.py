# ecommerce/bottega_retrogaming/migrations/0001_initial.py
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(blank=True, max_length=200, null=True, verbose_name='Nome visualizzato')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='bottega_retrogaming.order')),
            ],
        ),
        migrations.CreateModel(
            name='OrderItem',
            fields=[
                ...
                ('date_added', models.DateTimeField(auto_now_add=True)),
                ('order', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='bottega_retrogaming.order')),
                ('product', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='bottega_retrogaming.product')),
            ],
        ),
    ]